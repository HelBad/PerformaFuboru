package com.example.performafuboru.view.security.bukuharian
...
import kotlinx.android.synthetic.main.security_activity_bukuharian.*
...
class ActivityBukuharian : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.security_activity_bukuharian)
