...
import kotlinx.android.synthetic.main.admin_activity_izin_approval.*
...
class ActivityIzinApproval : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_izin_approval)
    ...
    private fun getData() {
        val fetchData = FetchData(ApiAdmin.IZIN_DETAIL +
    ...
    private fun addApproval(){
        AndroidNetworking.post(ApiAdmin.IZIN_APPROVAL_1)
            .addBodyParameter("kode_izin", intent.getStringExtra("kode").toString())
            .addBodyParameter("approval_1", SP.getString("username", "").toString())
